...
function ContactModal({
  ...
  return (
    ...
    >
      <div
        className="relative w-full max-w-[540px] max-h-[80vh] bg-parchment border border-parchment rounded-2xl shadow-[0_24px_80px_rgba(0,0,0,0.35)] overflow-hidden animate-[slideUp_0.3s_cubic-bezier(0.16,1,0.3,1)_both]"
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        <div className="mb-[18px]">
          ...
          <input
            ...
            className="w-full px-4 py-[13px] border border-black/12 rounded-md font-body text-sm text-text-primary bg-white transition-all duration-300 outline-none focus:border-river focus:shadow-[0_0_0_4px_rgba(58,107,124,0.08)]"
            {...register('name')}
          />
          {errors.name && (
        ...
        <div className="mb-[18px]">
          ...
          <textarea
            ...
            rows={4}
            className="w-full px-4 py-[13px] border border-black/12 rounded-md font-body text-sm text-text-primary bg-white transition-all duration-300 outline-none resize-y min-h-20 focus:border-river focus:shadow-[0_0_0_4px_rgba(58,107,124,0.08)]"
            {...register('message')}
          />
          {errors.message && (
            <span className="block text-xs text-red-600 mt-1" role="alert" aria-live="polite">
        ...
        <div className="mt-2">
          <button
            type="submit"
            className="w-full inline-flex items-center justify-center gap-2 px-6 py-[13px] rounded-full text-sm font-semibold text-white bg-forest transition-all duration-300 hover:bg-forest-deep hover:translate-y-[-2px] hover:shadow-[0_8px_30px_rgba(26,58,42,0.3)] disabled:opacity-60 disabled:cursor-not-allowed disabled:hover:translate-y-0"
