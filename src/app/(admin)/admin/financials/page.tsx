          ...
          <div className="grid gap-4 text-xs leading-relaxed text-text-light sm:grid-cols-2">
            <div>
              ...
              <ul className="mt-1 list-inside list-disc space-y-0.5">
                ...
                <li>$25/rod cross-club access fee ($20 AP + $5 home club referral)</li>
            ...
            <div>
              ...
              <ul className="mt-1 list-inside list-disc space-y-0.5">
                ...
                <li>Clubs receive $5/rod commission + membership fees + $5/rod referral when members fish cross-club</li>
