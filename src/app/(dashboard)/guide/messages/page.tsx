    ...
    <div className="mx-auto max-w-5xl space-y-4">
      <div>
        ...
        <p className="mt-1 text-sm text-text-secondary">
          Communicate with anglers and club managers.
        </p>
      </div>
      ...
      {threads.length === 0 ? (
        <Card className="border-stone-light/20">
          <CardContent className="flex flex-col items-center justify-center py-16">
            ...
            <p className="mt-1 text-sm text-text-secondary">
              Conversations with anglers and clubs will appear here.
            </p>
          </CardContent>
        </Card>
      ) : (
              ...
              >
                <div className="flex items-center justify-between">
                  ...
                  {thread.unread_count > 0 && (
                    <span className="flex size-5 items-center justify-center rounded-full bg-charcoal text-[10px] text-white">
                      {thread.unread_count}
                    </span>
                  )}
                </div>
                            ...
                            >
                              ...
                              <p
                                className={`mt-1 text-[10px] ${
                                  isOwn ? "text-white/60" : "text-text-light"
                                }`}
                              >
