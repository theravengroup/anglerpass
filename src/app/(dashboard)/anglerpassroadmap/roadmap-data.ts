    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          {
            id: "p1-aff-infra",
            label: "Affiliate link infrastructure in Compass AI",
            detail: "When Compass AI recommends gear, generate tracked affiliate links to partner retailers (Orvis, Bass Pro, Simms, etc.).",
            done: false,
          },
          {
            id: "p1-aff-tracking",
            label: "Multi-retailer affiliate tracking",
            detail: "Integration with affiliate networks (Impact, CJ Affiliate, or direct programs). Attribution tracking per click and conversion.",
            done: false,
          },
          {
            id: "p1-aff-recommendations",
            label: "Curated gear recommendations",
            detail: "AI-powered gear suggestions based on trip details (species, season, water type). Context-aware product matching.",
            done: false,
          },
          {
            id: "p1-aff-analytics",
            label: "Affiliate conversion analytics",
            detail: "Dashboard for click-through rates, conversion rates, and commission revenue from gear recommendations.",
            done: false,
          },
        ],
      },
