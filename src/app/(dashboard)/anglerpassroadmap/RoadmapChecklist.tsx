    ...
    sections: [
      {
        ...
        items: [
          ...
          },
          {
            ...
            detail: "Execute tiered refunds. Reverse payouts. Handle cancellation faults.",
            done: false,
          },
        ],
      },
      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            detail: "Data handling, Supabase/Stripe security, privacy practices.",
            done: false,
          },
        ],
      },
      {
        ...
        items: [
          {
            id: "p1-request-book",
            label: "Request-to-book toggle for landowners",
            detail: "1 column + API flag + UI toggle. Unlocks landowners who want approval control.",
            done: false,
          },
          {
            id: "p1-sentry",
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { id: "p3-lodging", label: "Lodging referral partnerships (structured booking, commission)", done: false },
