  ...
  return (
    <div className="space-y-4 text-center">
      ...
      <p className="text-sm text-text-secondary">
        Create your AnglerPass account to apply for membership. Already have an
        account? Sign in and we&rsquo;ll link you to this club.
      </p>
      <div className="flex flex-col items-center gap-3 sm:flex-row sm:justify-center">
        <Link
          href={`/signup?role=angler&clubId=${clubId}`}
