...
export const alt = 'About AnglerPass — Private Water Fly Fishing Platform';
  ...
  return jpegOgImage(
      ...
      >
        ...
        >
          ...
          >
            The only platform connecting fly anglers, clubs, and private landowners in one marketplace.
          </div>
        </div>
