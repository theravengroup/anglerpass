...
const sectionHeadingClass = 'font-heading text-[24px] font-semibold text-forest mb-5 tracking-[-0.2px]';
...
export default function PoliciesPage() {
  return (
    <>
      ...
      {/* Table of contents */}
      <section className="pt-[60px] bg-offwhite">
        <div className="max-w-[760px] mx-auto px-8">
          <nav className="bg-white border border-parchment rounded-[14px] py-6 px-7">
            <h2 className="text-[14px] font-semibold text-forest mb-3">
              On this page
            </h2>
      ...
      {/* Policy sections */}
      <section className="pt-[60px] pb-[120px] bg-offwhite">
        <div className="max-w-[760px] mx-auto px-8">

          {/* Membership & Applications */}
          <div id="membership" className="mb-16 scroll-mt-[120px]">
            <h2 className={sectionHeadingClass}>Membership &amp; Applications</h2>
            ...
            <ol className={`${textClass} pl-5`}>
              <li className="mb-[6px]">Angler submits a membership application through AnglerPass.</li>
              <li className="mb-[6px]">Club administrators review the application and may request additional information.</li>
              <li className="mb-[6px]">Club approves or declines the application.</li>
              <li className="mb-[6px]">If approved, the applicant is prompted to pay the initiation fee (if any) and first year&rsquo;s dues.</li>
              <li className="mb-[6px]">Once payment is confirmed, the membership becomes active.</li>
            </ol>
          ...
          {/* Dues & Renewals */}
          <div id="dues" className="mb-16 scroll-mt-[120px]">
            <h2 className={sectionHeadingClass}>Dues &amp; Renewals</h2>
            <p className={textClass}>
          ...
          <div id="cancellations" className="mb-16 scroll-mt-[120px]">
            <h2 className={sectionHeadingClass}>Membership Cancellations</h2>
            <p className={textClass}>
            ...
            <ul className={`${textClass} pl-5`}>
              <li className="mb-[6px]">Your membership remains active through the end of your current paid period.</li>
              <li className="mb-[6px]">Your annual dues subscription is cancelled &mdash; no further charges will be made.</li>
              <li className="mb-[6px]">Dues already paid are not refunded for partial years.</li>
              <li className="mb-[6px]">Any bookings scheduled after your membership end date will be automatically cancelled, and you will be notified.</li>
              <li className="mb-[6px]">Bookings within your remaining active period are unaffected.</li>
            </ul>
          ...
          <div id="removals" className="mb-16 scroll-mt-[120px]">
            <h2 className={sectionHeadingClass}>Club-Initiated Removal</h2>
            <p className={textClass}>
            ...
            <ul className={`${textClass} pl-5`}>
              <li className="mb-[6px]">Removal takes effect immediately. Access is revoked upon removal.</li>
              <li className="mb-[6px]">All future bookings are automatically cancelled and you will be notified.</li>
              <li className="mb-[6px]">There are no refunds or prorations of initiation fees or annual dues.</li>
              <li className="mb-[6px]">The annual dues subscription is cancelled immediately &mdash; no further charges will be made.</li>
              <li className="mb-[6px]">You will receive a notification with the reason for removal provided by the club.</li>
            </ul>
          ...
          {/* Rejoining a Club */}
          <div id="rejoining" className="mb-16 scroll-mt-[120px]">
            <h2 className={sectionHeadingClass}>Rejoining a Club</h2>
            <p className={textClass}>
            ...
            <ul className={`${textClass} pl-5`}>
              <li className="mb-[6px]">Rejoin fee: $175 (50% of $350) + $6.13 processing</li>
              <li className="mb-[6px]">Annual dues: $175 + $6.13 processing</li>
              <li className="mb-[6px]"><strong>Total to rejoin: $362.26</strong></li>
            </ul>
          ...
          {/* Payment Processing */}
          <div id="payments" className="mb-16 scroll-mt-[120px]">
            <h2 className={sectionHeadingClass}>Payment Processing</h2>
            <p className={textClass}>
          ...
          <div id="bookings" className="mb-16 scroll-mt-[120px]">
            <h2 className={sectionHeadingClass}>Booking Cancellations &amp; Refunds</h2>
            <p className={textClass}>
            ...
            <div className="bg-white border border-parchment rounded-[10px] overflow-hidden mt-4 mb-4">
              <table className="w-full border-collapse">
                <thead>
                  <tr className="bg-parchment-light">
                    <th className="text-left p-3 px-4 text-[13px] font-semibold text-forest">
                      Cancellation window
                    </th>
                    <th className="text-left p-3 px-4 text-[13px] font-semibold text-forest">
                      Refund
                ...
                <tbody>
                  {[
                    ...
                    <tr key={row.window} className="border-t border-parchment">
                      <td className="p-3 px-4 text-[14px] text-text-secondary">
                        {row.window}
                      </td>
                      <td className="p-3 px-4 text-[14px] text-text-secondary">
                        {row.refund}
          ...
          {/* Guide Services */}
          <div id="guide-services" className="mb-16 scroll-mt-[120px]">
            <h2 className={sectionHeadingClass}>Guide Services</h2>
            <p className={textClass}>
          ...
          {/* Guest Policy */}
          <div id="guest-policy" className="mb-16 scroll-mt-[120px]">
            <h2 className={sectionHeadingClass}>Guest Policy</h2>
            <p className={textClass}>
          ...
          {/* Club Subscriptions */}
          <div id="club-subscriptions" className="scroll-mt-[120px]">
            <h2 className={sectionHeadingClass}>Club Subscriptions</h2>
            <p className={textClass}>
